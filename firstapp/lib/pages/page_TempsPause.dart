...
class TempsPause extends StatefulWidget {
  const TempsPause({Key key}) : super(key: key);

  @override
  _TempsPauseState createState() => _TempsPauseState();
}

// ignore: camel_case_types
class _TempsPauseState extends State<TempsPause> {

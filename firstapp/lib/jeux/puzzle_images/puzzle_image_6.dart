...
class SlidePuzzle_6 extends StatefulWidget {
  SlidePuzzle_6({Key key}) : super(key: key);

  @override
  _SlidePuzzle_6State createState() => _SlidePuzzle_6State();
}

class _SlidePuzzle_6State extends State<SlidePuzzle_6> {
  // default put 2
  int valueSlider = 3;
  GlobalKey<_SlidePuzzle_6WidgetState> globalKey = GlobalKey();
                              ...
                              return Container(
                                ...
                                child: SlidePuzzle_6Widget(
                                  ...
                                  imageBckGround: Image(
                                    ...
                                    image:
                                        AssetImage("./assets/img/avatar_6.png"),
                                  ),
...
// statefull widget
class SlidePuzzle_6Widget extends StatefulWidget {
  Size size;
  // set inner padding
  double innerPadding;
  ...
  @override
  _SlidePuzzle_6WidgetState createState() => _SlidePuzzle_6WidgetState();
}

class _SlidePuzzle_6WidgetState extends State<SlidePuzzle_6Widget> {

...
class SlidePuzzle_5 extends StatefulWidget {
  SlidePuzzle_5({Key key}) : super(key: key);

  @override
  _SlidePuzzle_5State createState() => _SlidePuzzle_5State();
}

class _SlidePuzzle_5State extends State<SlidePuzzle_5> {
  // default put 2
  int valueSlider = 3;
  GlobalKey<_SlidePuzzle_5WidgetState> globalKey = GlobalKey();
                              ...
                              return Container(
                                ...
                                child: SlidePuzzle_5Widget(
                                  ...
                                  imageBckGround: Image(
                                    ...
                                    image:
                                        AssetImage("./assets/img/avatar_5.png"),
                                  ),
...
// statefull widget
class SlidePuzzle_5Widget extends StatefulWidget {
  Size size;
  // set inner padding
  double innerPadding;
  ...
  @override
  _SlidePuzzle_5WidgetState createState() => _SlidePuzzle_5WidgetState();
}

class _SlidePuzzle_5WidgetState extends State<SlidePuzzle_5Widget> {
